...
CREATE TABLE `properties` (
  ...
  `property_contact` varchar(200) DEFAULT NULL,
...
INSERT INTO `properties` VALUES (1,'BVC N324','N324','Classroom','BVC North Campus','Downtown Calgary',900,40,'No','No','2022-06-30','Daily',80,'info@houses.ca');
